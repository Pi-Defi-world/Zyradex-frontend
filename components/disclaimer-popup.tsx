        ...
        <div className="overflow-hidden">
          <ScrollArea className="h-full">
            <div className="p-6 space-y-4 text-sm text-muted-foreground leading-relaxed">
              <p>
                This website-hosted user interface (this "Interface") is an open source frontend software portal to the ZyraDex protocol, a decentralized and community-driven collection of blockchain-enabled tools (the "ZyraDex Protocol"). This Interface and the ZyraDex Protocol are made available by the Provenalabs. As the Interface is open-sourced and the ZyraDex Protocol and its related tools are accessible by any user, entity or third party, there are a number of third party web and mobile user-interfaces that allow for interaction with the ZyraDex Protocol.
              </p>
              
              <p className="font-semibold text-foreground">
                THIS INTERFACE AND THE ZYRADex PROTOCOL ARE PROVIDED "AS IS", AT YOUR OWN RISK, AND WITHOUT WARRANTIES OF ANY KIND. The ZyraDex Foundation does not provide, own, or control the ZyraDex Protocol or any transactions conducted on the protocol or via related tools. By using or accessing this Interface or the ZyraDex Protocol and related tools, you agree that no developer or entity involved in creating, deploying or maintaining this Interface or the ZyraDex Protocol will be liable for any claims or damages whatsoever associated with your use, inability to use, or your interaction with other users of, this Interface or the ZyraDex Protocol, including any direct, indirect, incidental, special, exemplary, punitive or consequential damages, or loss of profits, digital assets, tokens, or anything else of value.
              </p>
              
              <p>
                The ZyraDex Protocol is not available to jurisdiction in which accessing or using the ZyraDex Protocol is prohibited (the "Prohibited Jurisdictions").
              </p>
